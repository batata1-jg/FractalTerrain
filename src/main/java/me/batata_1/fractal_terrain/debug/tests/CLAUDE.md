...
| `RiverTest.java`              | Loads models, builds `GlobalRiverProvider`/`RiverProvider` directly, dumps flow/mask/carve/channel PNGs, checks bed monotonicity, dumps the primitive tree | `riverTest`               | Visual/manual local riverPrimitive network check                    |
