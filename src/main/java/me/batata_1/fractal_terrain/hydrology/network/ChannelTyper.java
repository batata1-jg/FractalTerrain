 ...
 * never the reverse.
 *
 * <p>Two-phase because a type depends on neighbouring channels: {@link RiverNetwork#collectPrimitives}
...
public interface ChannelTyper {
    ...
    /** Called once per {@code collectPrimitives}, after every channel is resampled and before any lookup. */
     ...
     *  {@link RiverNetwork#collectPrimitives} can decide. */
