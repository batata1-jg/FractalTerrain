...
| `HydrologyProfile.java`       | The extension point: `shellElevation` is its whole contract — no zone radius, selection or weight member | Adding a feature type's carve behaviour                                    |
