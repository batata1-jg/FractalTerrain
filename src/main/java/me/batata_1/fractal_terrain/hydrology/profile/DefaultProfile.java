 ...
 * unmodified.
 *
 * <p>Exists so a newly added feature type carves something plausible from the day it is indexed: a primitive
 * on this profile still blends into the influence average and simply loses to any overlapping primitive
