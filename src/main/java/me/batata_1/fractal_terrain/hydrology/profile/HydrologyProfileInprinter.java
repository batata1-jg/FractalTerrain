 ...
 * before running {@link LatticeCarve}'s lattice carve over the chunk. The stateless carve math
 * itself lives in {@link LatticeCarve}, kept apart so this class's {@code providers} import
...
public final class HydrologyProfileInprinter {
    ...
    public static void carvePrimitives(LatticeCarve.GridBuffers buffers, List<HydrologicalPrimitive> primitives) {
