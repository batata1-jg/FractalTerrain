...
/**
 * The carve zones a unit can claim a point for, <b>declared in descending priority order</b>.
 *
 * <p>The order answers "when two feature types overlap, whose cross-section wins?" — one flat global
 * ranking rather than per-profile, since units of different types must be comparable.
 *
...
public enum ZoneCategory {
    ...
    /** The outer blend band; lowest priority, and every unit's default fallback zone. */
    INFLUENCE;
