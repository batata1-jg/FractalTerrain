...
/**
 * The {@code OpenSimplex2S} noise-type strategy: a modified simplex noise (2D) / two offset rotated
 * cube grids with extra corner contributions (3D) that trade some of OpenSimplex2's directional
 * artifacts for smoother output.
 *
 * <p><b>Responsibility:</b> both overloads of {@link #SingleOpenSimplex2S} - the
 * {@code NoiseType.OpenSimplex2S} branch of {@code FastNoiseLite}'s noise dispatcher.
 *
