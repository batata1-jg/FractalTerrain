...
public final class ModConfig {
    ...
    /** Reached only when the bundled properties resource fails to load entirely. */
    private static final boolean DEFAULT_OFFLOAD_MODELS = false;

    /** Fallback for a failed properties load; {@code loadDefaults} sets it explicitly in that branch. */
