...
public class FractalTerrainSurfaceRules {
    ...
    public static MaterialRules.MaterialRule createDefaultRule(boolean surface, boolean bedrockRoof, boolean bedrockFloor) {
        ...
        MaterialRules.MaterialCondition isAbove63WithStoneDepth = MaterialRules.aboveYWithStoneDepth(YOffset.fixed(63), -1);
        MaterialRules.MaterialCondition isAbove74WithStoneDepth = MaterialRules.aboveYWithStoneDepth(YOffset.fixed(74), 1);
        ...
        MaterialRules.MaterialRule placeGrassAndDirt = MaterialRules.sequence(MaterialRules.condition(isAboveWaterZero, GRASS_BLOCK), DIRT);
        MaterialRules.MaterialRule placeSandAndSandstone = MaterialRules.sequence(MaterialRules.condition(MaterialRules.STONE_DEPTH_CEILING, SANDSTONE), SAND);
        MaterialRules.MaterialRule placeGravelAndStone = MaterialRules.sequence(MaterialRules.condition(MaterialRules.STONE_DEPTH_CEILING, STONE), GRAVEL);
        MaterialRules.MaterialCondition isBeachOrWarmOcean = MaterialRules.biome(BiomeKeys.WARM_OCEAN, BiomeKeys.BEACH, BiomeKeys.SNOWY_BEACH);
        ...
        MaterialRules.MaterialRule realizeStonyPeaks_StonyShore_WindsweptHills_DripstoneCaves = MaterialRules.sequence(
                ...
                MaterialRules.condition(
                        ...
                        MaterialRules.sequence(MaterialRules.condition(MaterialRules.noiseThreshold(NoiseParametersKeys.GRAVEL, -0.05, 0.05), placeGravelAndStone), STONE)
                ),
        ...
        MaterialRules.MaterialRule placePowderSnow1 = MaterialRules.condition(
                MaterialRules.noiseThreshold(NoiseParametersKeys.POWDER_SNOW, 0.45, 0.58), MaterialRules.condition(isAboveWaterZero, POWDER_SNOW)
        );
        MaterialRules.MaterialRule placePowderSnow2 = MaterialRules.condition(
                MaterialRules.noiseThreshold(NoiseParametersKeys.POWDER_SNOW, 0.35, 0.6), MaterialRules.condition(isAboveWaterZero, POWDER_SNOW)
        );
        MaterialRules.MaterialRule realizeFrozenPeaks_SnowySlopes_JaggedPeaks_Grove_WindsweptSavanna_WindsweptGravellyHills_MangroveSwamp = MaterialRules.sequence(
                MaterialRules.condition(
                ...
                MaterialRules.condition(
                        ...
                        MaterialRules.sequence(MaterialRules.condition(isSteep, STONE), placePowderSnow1, MaterialRules.condition(isAboveWaterZero, SNOW_BLOCK))
                ),
                MaterialRules.condition(MaterialRules.biome(BiomeKeys.JAGGED_PEAKS), STONE),
                MaterialRules.condition(MaterialRules.biome(BiomeKeys.GROVE), MaterialRules.sequence(placePowderSnow1, DIRT)),
                ...
                MaterialRules.condition(
                        ...
                        MaterialRules.sequence(
                                MaterialRules.condition(surfaceNoiseThreshold(2.0), placeGravelAndStone),
        ...
        MaterialRules.MaterialRule realizeFrozenPeaks_SnowySlopes_JaggedPeaks_Grove_WindsweptSavanna_WindsweptGravellyHills_OldGrowthPineTaiga_IceSpikes_MangroveSwamp_MushroomFields = MaterialRules.sequence(
                MaterialRules.condition(
                        MaterialRules.biome(BiomeKeys.FROZEN_PEAKS),
                        MaterialRules.sequence(
                                MaterialRules.condition(isSteep, PACKED_ICE),
                ...
                MaterialRules.condition(
                        MaterialRules.biome(BiomeKeys.SNOWY_SLOPES),
                        MaterialRules.sequence(MaterialRules.condition(isSteep, STONE), placePowderSnow2, MaterialRules.condition(isAboveWaterZero, SNOW_BLOCK))
                ),
                MaterialRules.condition(
                        MaterialRules.biome(BiomeKeys.JAGGED_PEAKS),
                        MaterialRules.sequence(MaterialRules.condition(isSteep, STONE), MaterialRules.condition(isAboveWaterZero, SNOW_BLOCK))
                ),
                MaterialRules.condition(MaterialRules.biome(BiomeKeys.GROVE), MaterialRules.sequence(placePowderSnow2, MaterialRules.condition(isAboveWaterZero, SNOW_BLOCK))),
                realizeStonyPeaks_StonyShore_WindsweptHills_DripstoneCaves,
                MaterialRules.condition(
                ...
                MaterialRules.condition(MaterialRules.biome(BiomeKeys.ICE_SPIKES), MaterialRules.condition(isAboveWaterZero, SNOW_BLOCK)),
                MaterialRules.condition(MaterialRules.biome(BiomeKeys.MANGROVE_SWAMP), MUD),
                MaterialRules.condition(MaterialRules.biome(BiomeKeys.MUSHROOM_FIELDS), MYCELIUM),
                placeGrassAndDirt
        );
        MaterialRules.MaterialCondition noiseThreshold1 = MaterialRules.noiseThreshold(NoiseParametersKeys.SURFACE, -0.909, -0.5454);
        MaterialRules.MaterialCondition noiseThreshold2 = MaterialRules.noiseThreshold(NoiseParametersKeys.SURFACE, -0.1818, 0.1818);
        MaterialRules.MaterialCondition noiseThreshold3 = MaterialRules.noiseThreshold(NoiseParametersKeys.SURFACE, 0.5454, 0.909);
        MaterialRules.MaterialRule realizeEverything = MaterialRules.sequence(
                        ...
                        MaterialRules.sequence(
                                ...
                                MaterialRules.condition(
                                        ...
                                        MaterialRules.condition(
                                                isAboveY62,
                                                MaterialRules.condition(
                                                        MaterialRules.not(isAboveY63), MaterialRules.condition(MaterialRules.noiseThreshold(NoiseParametersKeys.SURFACE_SWAMP, 0.0), WATER)
                                                )
                                        )
                                ),
                                MaterialRules.condition(
                        ...
                        MaterialRules.sequence(
                                MaterialRules.condition(
                                        ...
                                        MaterialRules.sequence(
                                                ...
                                                MaterialRules.condition(isAboveWaterMinusOne, MaterialRules.sequence(MaterialRules.condition(MaterialRules.STONE_DEPTH_CEILING, RED_SANDSTONE), RED_SAND)),
                                                MaterialRules.condition(MaterialRules.not(theHoleOne), ORANGE_TERRACOTTA),
                                ...
                                MaterialRules.condition(
                                        ...
                                        MaterialRules.sequence(
                                                MaterialRules.condition(isAboveY63, MaterialRules.condition(MaterialRules.not(isAbove74WithStoneDepth), ORANGE_TERRACOTTA)),
                                                MaterialRules.terracottaBands()
                                        )
                                ),
                        ...
                        MaterialRules.condition(
                                ...
                                MaterialRules.sequence(
                                        MaterialRules.condition(
                                                ...
                                                MaterialRules.condition(
                                                        theHoleOne,
                                                        MaterialRules.sequence(MaterialRules.condition(isAboveWaterZero, AIR), MaterialRules.condition(MaterialRules.temperature(), ICE), WATER)
                                                )
                                        ),
                ...
                MaterialRules.condition(
                        waterWithStoneDepth,
                        MaterialRules.sequence(
                                MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR, MaterialRules.condition(isFrozenOcean, MaterialRules.condition(theHoleOne, WATER))),
                                MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH, realizeFrozenPeaks_SnowySlopes_JaggedPeaks_Grove_WindsweptSavanna_WindsweptGravellyHills_MangroveSwamp),
                                MaterialRules.condition(isBeachOrWarmOcean, MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH_RANGE_6, SANDSTONE)),
                                MaterialRules.condition(isDesert, MaterialRules.condition(MaterialRules.STONE_DEPTH_FLOOR_WITH_SURFACE_DEPTH_RANGE_30, SANDSTONE))
                        )
                ),
                MaterialRules.condition(
                        MaterialRules.STONE_DEPTH_FLOOR,
                        MaterialRules.sequence(
                                ...
                                MaterialRules.condition(MaterialRules.biome(BiomeKeys.WARM_OCEAN, BiomeKeys.LUKEWARM_OCEAN, BiomeKeys.DEEP_LUKEWARM_OCEAN), placeSandAndSandstone),
                                placeGravelAndStone
                        )
                )
        );
        ...
        MaterialRules.MaterialRule conditionOnSlopeTest = MaterialRules.condition(MaterialRules.not(fracSteepSlope), realizeEverything);
    ...
    public static MaterialRules.MaterialRule createLargeRule(boolean surface, boolean bedrockRoof, boolean bedrockFloor) {
        MaterialRules.MaterialCondition isAboveY97 = MaterialRules.aboveY(YOffset.fixed(97), 2);
        MaterialRules.MaterialCondition isAboveY256 = MaterialRules.aboveY(YOffset.fixed(256), 0);
        MaterialRules.MaterialCondition isAbove63WithStoneDepth = MaterialRules.aboveYWithStoneDepth(YOffset.fixed(63), -1);
        MaterialRules.MaterialCondition isAbove74WithStoneDepth = MaterialRules.aboveYWithStoneDepth(YOffset.fixed(74), 1);
