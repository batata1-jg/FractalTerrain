...
public final class FractalTerrainDensityFunctionTypes {
  ...
  public static void register() {
    ...
    Registry.register(
        registry, Reference.identifier("preliminary_surface"), PreliminarySurface.CODEC);
    ...
    Registry.register(
        registry,
        Reference.identifier("erosion_refined_blurred_grad"),
        RefinedErosionBlurredGrad.CODEC);
  ...
  public static class RefinedElevation extends InterpolatedFromMap {
    ...
    public static final Codec<RefinedElevation> CODEC =
  ...
  public static class PreliminarySurface extends InterpolatedFromMap {
    ...
    public static final Codec<PreliminarySurface> CODEC =
        RecordCodecBuilder.create(
            instance ->
                instance
  ...
  public static class Depth extends InterpolatedFromMap {
    ...
    public static final Codec<Depth> CODEC =
        RecordCodecBuilder.create(
            instance ->
                instance
                    .group(Codec.FLOAT.optionalFieldOf("scale", 0.2F).forGetter(null))
  ...
  public static class RefinedContinents extends InterpolatedFromMap {
    ...
    public static final Codec<RefinedContinents> CODEC =
        RecordCodecBuilder.create(
            instance ->
                instance
                    .group(
    ...
    public DensityFunction apply(DensityFunctionVisitor visitor) {
      ...
      interp.setF(
          xz ->
              (float)
                  (Math.tanh(FractalTerrainInstance.post.getContinentalElev(xz) / normFactor)
                      * 1.5F));
      return visitor.apply(this);
    }
  ...
  public static class RawTemp extends InterpolatedFromMap {
    ...
    public static final Codec<RawTemp> CODEC =
        RecordCodecBuilder.create(
            instance ->
                instance
                    .group(
    ...
    public DensityFunction apply(DensityFunctionVisitor visitor) {
      ...
      interp.setF(
          xz ->
              (float) (Math.tanh(FractalTerrainInstance.post.getRawTemp(xz) / normFactor) * 2.31));
      return visitor.apply(this);
    }
  ...
  public static class RawTempSTD extends InterpolatedFromMap {
    ...
    public static final Codec<RawTempSTD> CODEC =
        RecordCodecBuilder.create(
            instance ->
                instance
                    .group(Codec.FLOAT.fieldOf("scale").forGetter(null))
  ...
  public static class RawPrecip extends InterpolatedFromMap {
    ...
    public static final Codec<RawPrecip> CODEC =
        RecordCodecBuilder.create(
            instance ->
                instance
                    .group(
    ...
    public DensityFunction apply(DensityFunctionVisitor visitor) {
      ...
      interp.setF(
          xz ->
              (float)
                  (Math.tanh(FractalTerrainInstance.post.getRawPrecip(xz) / normFactor) * 1.76));
      return visitor.apply(this);
    }
  ...
  public static class RawPrecipSTD extends InterpolatedFromMap {
    ...
    public static final Codec<RawPrecipSTD> CODEC =
        RecordCodecBuilder.create(
            instance ->
                instance
                    .group(Codec.FLOAT.fieldOf("scale").forGetter(null))
  ...
  public static class RawErosionGrad extends InterpolatedFromMap {
    ...
    public static final Codec<RawErosionGrad> CODEC =
        RecordCodecBuilder.create(
            erosionInstance ->
                erosionInstance
  ...
  public static class RefinedErosionBlurredGrad extends InterpolatedFromMap {
    ...
    public DensityFunction apply(DensityFunctionVisitor visitor) {
      interp.setF(
          xz ->
              (float)
                  (Math.tanh(1 - FractalTerrainInstance.post.getBlurredGrad(xz) / normFactor)
                      * 2.52));
      return visitor.apply(this);
    }
  ...
  public static class RefinedErosionGrad extends InterpolatedFromMap {
    ...
    public DensityFunction apply(DensityFunctionVisitor visitor) {
      interp.setF(
          xz -> {
            return (float)
                (Math.tanh(1 - FractalTerrainInstance.post.getRefinedGrad(xz) / 10.0) * normFactor);
          });
      return visitor.apply(this);
    }
