...
public final class FractalTerrainDensityFunctionTypes {
    ...
    public static void register() {
        ...
        Registry.register(registry,Reference.identifier("erosion_refined_blurred_grad"), RefinedErosionBlurredGrad.CODEC);
    ...
    public abstract static class InterpolatedFromMap implements DensityFunction {
        ...
        protected synchronized void setSeed() {
            seed = FractalTerrainInstance.getServer().getSaveProperties().getGeneratorOptions().getSeed();
            seedActive.set(true);
        }
    ...
    public static class RefinedElevation extends InterpolatedFromMap {
        ...
        public static final Codec<RefinedElevation> CODEC = RecordCodecBuilder.create(instance ->
                instance.group(
    ...
    public static class PreliminarySurface extends InterpolatedFromMap {
        ...
        public static final Codec<PreliminarySurface> CODEC = RecordCodecBuilder.create(instance ->
                instance.group(
                        Codec.FLOAT.optionalFieldOf("scale",0.2F).forGetter(null)
    ...
    public static class Depth extends InterpolatedFromMap {
        ...
        public static final Codec<Depth> CODEC = RecordCodecBuilder.create(instance ->
                instance.group(
                        Codec.FLOAT.optionalFieldOf("scale",0.2F).forGetter(null)
    ...
    public static class RefinedContinents extends InterpolatedFromMap {
        ...
        public DensityFunction apply(DensityFunctionVisitor visitor) {
            super.applySeed();
            interp.setF(xz -> (float) (Math.tanh(FractalTerrainInstance.post.getContinentalElev(xz)/normFactor)*1.5F));
            return visitor.apply(this);
        }
    ...
    public static class RawTempSTD extends InterpolatedFromMap {
        ...
        public static final Codec<RawTempSTD> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                Codec.FLOAT.fieldOf("scale").forGetter(null)
        ).apply(instance, RawTempSTD::new));
    ...
    public static class RawPrecipSTD extends InterpolatedFromMap {
        ...
        public static final Codec<RawPrecipSTD> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                Codec.FLOAT.fieldOf("scale").forGetter(null)
        ).apply(instance, RawPrecipSTD::new));
    ...
    public static class RawErosionGrad extends InterpolatedFromMap {
        ...
        public static final Codec<RawErosionGrad> CODEC = RecordCodecBuilder.create(erosionInstance -> erosionInstance.group(
                Codec.FLOAT.optionalFieldOf("scale",64F).forGetter(null)
        ...
        public DensityFunction apply(DensityFunctionVisitor visitor) {
            ...
            interp.setF( xz -> {
//                LOGGER.info("asdasdsdasd{}",xz);
//                throw new RuntimeException("morrerueureur");
    ...
    public static class RefinedErosionBlurredGrad extends InterpolatedFromMap {
        ...
        public static final Codec<RefinedErosionBlurredGrad> CODEC = RecordCodecBuilder.create(erosionInstance -> erosionInstance.group(
                Codec.FLOAT.optionalFieldOf("scale",0.2F).forGetter(null),
                Codec.DOUBLE.optionalFieldOf("norm_factor",10.0).forGetter(o ->o.normFactor)
        ...
        @Override
        public DensityFunction apply(DensityFunctionVisitor visitor) {
            interp.setF( xz -> (float) (Math.tanh( 1 - FractalTerrainInstance.post.getBlurredGrad(xz)/normFactor  )*2.52));
            return visitor.apply(this);
        }
    ...
    public static class RefinedErosionGrad extends InterpolatedFromMap {
        ...
        public static final Codec<RefinedErosionGrad> CODEC = RecordCodecBuilder.create(erosionInstance -> erosionInstance.group(
                Codec.FLOAT.optionalFieldOf("scale",0.2F).forGetter(null)
