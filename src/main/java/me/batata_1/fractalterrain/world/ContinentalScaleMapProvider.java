...
public class ContinentalScaleMapProvider {
  ...
  public record Settings(
      float min, float max, double amplitude, float offset, OctaveSimplexNoiseSampler sampler) {}
  ...
  public static final Settings elevSettings =
      new Settings(
          ...
          90,
          30,
          new OctaveSimplexNoiseSampler(1, 8, 1.0, 60.0, 0.7, 0.6, null, Math::sin));
  ...
  public static final Settings tempSettings =
      new Settings(
          -40, 30, 50, 10, new OctaveSimplexNoiseSampler(2, 5, 1.3, 90.0, 0.6, 0.7, null, null));
  ...
  public static final Settings tempSTDSettings =
      new Settings(
          0, 200, 100, 100, new OctaveSimplexNoiseSampler(3, 8, 1.0, 80.0, 0.5, 0.6, null, null));
  ...
  public static final Settings precipSettings =
      new Settings(
          ...
          2200,
          -200,
          new OctaveSimplexNoiseSampler(4, 14, 1.4, 80.0, 0.6, 0.4, null, null));
  ...
  public static final Settings precipSTDSettings =
      new Settings(
          0, 20, 10, 10, new OctaveSimplexNoiseSampler(5, 12, 1.0, 100.0, 0.5, 0.7, null, null));
