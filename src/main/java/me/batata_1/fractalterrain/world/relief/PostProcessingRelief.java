...
public class PostProcessingRelief {
  ...
  public PostProcessingRelief(
      FractalTerrainDensityFunctionTypes.RefinedElevation.Settings settings) {
                                    ...
                                    (OnnxTensor)
                                        average
                                            .run(
                                                Map.of(
                                                    "x",
                                                    decodeAndFinish.getCoarseTilesAsTensor(
        ...
        new EntryStorage<>(
            ...
            (xz) -> {
              ...
              try {
                OnnxTensor t =
                    (OnnxTensor)
                        average.run(Map.of("x", decodeAndFinish.getTilesAsTensor(x, z))).get(0);
  ...
  public float getRawTemp(Pair<Integer, Integer> xz) {
    ...
    double val =
        ContinentalScaleMapProvider.sampleTemperature(
  ...
  public float getRawPrecip(Pair<Integer, Integer> xz) {
    return (float)
        ContinentalScaleMapProvider.samplePrecipitation(
            convertCoarse(xz).getFirst(), convertCoarse(xz).getSecond());
  }
  ...
  public static class DecodeAndFinish extends StorageInterface {
    ...
    public DecodeAndFinish(FractalTerrainDensityFunctionTypes.RefinedElevation.Settings settings) {
      super(
          new EntryStorage<>("decoder", TileRegion::new, 256),
          256 * 256 * 2,
          new long[] {2, 256, 256});
